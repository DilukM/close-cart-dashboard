...
const Navbar = ({ toggleTheme, isDarkMode, className, toggleSidebar }) => {
  ...
  return (
    <nav
      className={`bg-white dark:bg-gray-900 shadow-md py-3 px-6 ${className}`}
    ...
    >
      <div className="flex items-center justify-between">
        <div className="flex items-center">
          ...
          {/* Logo - hidden on small screens, visible on larger screens */}
          <img
            src="/assets/logo.png"
            alt="Logo"
          ...
          {/* Other navbar left-side content */}
          {/* ...existing left navbar code... */}
        </div>
