    ...
    <div>
      ...
      <div className="space-y-4">
        <input
          ...
          className="w-full px-4 py-2 dark:bg-gray-700 bg-gray-200 border border-gray-600 rounded-lg dark:text-white text-gray-600 focus:outline-none focus:border-yellow-500"
        ...
        <div>
          <select
            ...
            className="w-full px-4 py-2 dark:bg-gray-700 bg-gray-200 border border-gray-600 rounded-lg dark:text-white text-gray-600 focus:outline-none focus:border-yellow-500 appearance-none"
          >
        ...
        <div>
          ...
          <div className="flex">
            <input
              ...
              className="flex-1 px-4 py-2 dark:bg-gray-700 bg-gray-200 border border-gray-600 rounded-lg dark:text-white text-gray-600 focus:outline-none focus:border-yellow-500"
            />
            <button
              onClick={handleAddTag}
              className="px-3 py-2 ml-3 bg-gray-600 hover:bg-gray-500 dark:text-white text-gray-600 rounded-r-lg"
            >
              <Plus size={18} />
            </button>
          </div>
        ...
        <div className="grid grid-cols-2 gap-4">
          ...
          <div>
            ...
            <input
              type="date"
              className="w-full px-4 py-2 dark:bg-gray-700 bg-gray-200 border border-gray-600 rounded-lg dark:dark:text-white text-gray-600 text-gray-600 focus:outline-none focus:border-yellow-500"
        ...
        <div className="flex justify-end gap-4 mt-6">
          <button
            className="px-4 py-2 dark:bg-gray-700 bg-gray-200 dark:text-white text-gray-600 rounded-lg hover:bg-gray-600 transition-colors duration-300"
            onClick={onClose}
